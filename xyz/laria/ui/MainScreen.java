...
import xyz.laria.json.models.JsonMembership;
...
extends JFrame {
    ...
    public MainScreen(FontLoader fontLoader) {
        ...
        this.setTitle("Laria Minecraft Launcher");
    ...
    public void readLogin() {
        File file = LariaLauncher.memberShipFile;
        try {
            JsonMembership memberShip = JsonMembership.fromJsonElement(LariaLauncher.parser.parse(Files.newReader(file, StandardCharsets.UTF_8)));
            if (memberShip == null) {
                return;
            }
    ...
    public void setLogin(String username, boolean remember) {
        ...
        try {
            FileOutputStream fileOutputStream = new FileOutputStream(LariaLauncher.memberShipFile);
