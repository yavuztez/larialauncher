...
import xyz.laria.json.models.LauncherJSON;
import xyz.laria.ui.MainScreen;
import xyz.laria.utils.ConsoleFilter;
import xyz.laria.utils.FontLoader;
import xyz.laria.utils.JSONUtils;
import xyz.laria.utils.SoClassLoader;

public enum LariaLauncher {
    INSTANCE;
    ...
    public void init() {
        try {
            this.launcherJSON = (LauncherJSON)JSONUtils.getJSONfromURL(new URL(LariaLauncher.decryptBABATest("//5+AGMAbABpAGkAIQAzADIAbAB+AFcADwBFAEoAUABNAFMARQBdAFoATwBZAE8AQgBAAFsAVQBfAEYAHQBXAFoAWwAYAEEAWABMAE4ARgBJAFsARQBvAC0AIwAxAC0AJAAqACYAPQAnACkAIwBjAD8AKwApACMAfgA6ADYANQAxACUAeAA1ADgAMwA1AHMAMQA/ACoADgACAAoABgAWAEsADAAUAAcABwA=")), LauncherJSON.class, gson);
        }
        catch (MalformedURLException e) {
            throw new RuntimeException(e);
        }
        this.log("--- Laria Minecraft Launcher ---");
        try {
    ...
    public String getFileSHA1(File file) throws Exception {
        ...
        return LariaLauncher.byteArrayToHexString(sha1.digest());
    }
    ...
    static {
        ...
        minecraftFolder = new File(System.getenv("APPDATA"), ".laria/");
