...
public class MinecraftThread extends Thread {
    ...
    public void run() {
        try {
            ...
            this.getContextClassLoader().loadClass("net.minecraft.client.main.Main").getMethod("main", String[].class).invoke((Object)null, mArgs);
        ...
        for(int i2 = 0; i2 < stringArray.length; ++i2) {
            ...
            if (!string2.startsWith("--")) {
                ...
                if (string2.equalsIgnoreCase("${game_directory}")) {
                    stringArray[i2] = (new File(LariaLauncher.minecraftFolder, "game-directories/public")).getAbsolutePath();
                }

                if (string2.equalsIgnoreCase("${game_assets}")) {
                    stringArray[i2] = (new File(LariaLauncher.minecraftFolder, "assets/virtual")).getAbsolutePath();
                }

                if (string2.equalsIgnoreCase("${assets_root}")) {
                    stringArray[i2] = (new File(LariaLauncher.minecraftFolder, "assets")).getAbsolutePath();
                }
                ...
                if (string2.equalsIgnoreCase("${version_type}")) {
