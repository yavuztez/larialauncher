...
public class FontLoader {
    ...
    public Font x(String string, int n, int n2, double d) {
        ...
        HashMap<TextAttribute, Double> hashMap = new HashMap<TextAttribute, Double>();
    ...
    private static Font v(String string) {
        try {
            ...
            LogManager.getRootLogger().log(Level.WARN, "Bir hata olu\u015ftu!", (Throwable)exception);
            return null;
        }
    }
}
